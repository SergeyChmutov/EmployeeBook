...
import static pro.sky.employee.constants.EmployeeServiceConstants.*;
...
public class EmployeeServiceTest {
    ...
    public void shouldReturnEmployeeWhenAddMethodCallWithCapitalizedNames() {
        ...
        assertEquals(expected.getSalary(), EMPLOYEE_SALARY);
        assertEquals(expected.getDepartment(), EMPLOYEE_DEPARTMENT);
    }
    ...
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenAddMethodCallWithBlankFirstName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.add(EMPLOYEE_BLANK_NAME, EMPLOYEE_LASTNAME_1, EMPLOYEE_SALARY, EMPLOYEE_DEPARTMENT));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenAddMethodCallWithBadLastName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.add(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_BAD_LASTNAME, EMPLOYEE_SALARY, EMPLOYEE_DEPARTMENT));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenAddMethodCallWithNullLastName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.add(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_NULL_NAME, EMPLOYEE_SALARY, EMPLOYEE_DEPARTMENT));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenAddMethodCallWithEmptyLastName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.add(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_EMPTY_NAME, EMPLOYEE_SALARY, EMPLOYEE_DEPARTMENT));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenAddMethodCallWithBlankLastName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.add(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_BLANK_NAME, EMPLOYEE_SALARY, EMPLOYEE_DEPARTMENT));
    }

    @Test
    public void shouldReturnThrowIllegalArgumentExceptionWhenAddMethodCallWithNullSalary() {
        assertThrows(IllegalArgumentException.class, () -> out.add(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_LASTNAME_1, EMPLOYEE_NULL_SALARY, EMPLOYEE_DEPARTMENT));
    }

    @Test
    public void shouldReturnThrowIllegalArgumentExceptionWhenAddMethodCallWithZeroSalary() {
        assertThrows(IllegalArgumentException.class, () -> out.add(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_LASTNAME_1, EMPLOYEE_ZERO_SALARY, EMPLOYEE_DEPARTMENT));
    }

    @Test
    public void shouldReturnThrowIllegalArgumentExceptionWhenAddMethodCallWithNegativeSalary() {
        assertThrows(IllegalArgumentException.class, () -> out.add(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_LASTNAME_1, EMPLOYEE_NEGATIVE_SALARY, EMPLOYEE_DEPARTMENT));
    }

    @Test
    public void shouldReturnThrowIllegalArgumentExceptionWhenAddMethodCallWithNullDepartment() {
        assertThrows(IllegalArgumentException.class, () -> out.add(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_LASTNAME_1, EMPLOYEE_SALARY, EMPLOYEE_NULL_DEPARTMENT));
    }

    @Test
    public void shouldReturnThrowIllegalArgumentExceptionWhenAddMethodCallWithZeroDepartment() {
        assertThrows(IllegalArgumentException.class, () -> out.add(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_LASTNAME_1, EMPLOYEE_SALARY, EMPLOYEE_ZERO_DEPARTMENT));
    }

    @Test
    public void shouldReturnThrowIllegalArgumentExceptionWhenAddMethodCallWithNegativeDepartment() {
        assertThrows(IllegalArgumentException.class, () -> out.add(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_LASTNAME_1, EMPLOYEE_SALARY, EMPLOYEE_NEGATIVE_DEPARTMENT));
    }
    ...
    public void shouldReturnEmployeeWhenFindMethodCallCapitalizedNames() {
        Employee employeeActual = out.add(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_LASTNAME_1, EMPLOYEE_SALARY, EMPLOYEE_DEPARTMENT);
    ...
    public void shouldReturnEmployeeWhenFindMethodCallNonCapitalizedNames() {
        Employee employeeActual = out.add(EMPLOYEE_FIRSTNAME_2, EMPLOYEE_LASTNAME_2, EMPLOYEE_SALARY, EMPLOYEE_DEPARTMENT);
    ...
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenFindMethodCallWithNullFirstName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.find(EMPLOYEE_NULL_NAME, EMPLOYEE_LASTNAME_1));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenFindMethodCallWithEmptyFirstName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.find(EMPLOYEE_EMPTY_NAME, EMPLOYEE_LASTNAME_1));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenFindMethodCallWithBlankFirstName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.find(EMPLOYEE_BLANK_NAME, EMPLOYEE_LASTNAME_1));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenFindMethodCallWithBadLastName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.find(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_BAD_LASTNAME));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenFindMethodCallWithNullLastName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.find(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_NULL_NAME));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenFindMethodCallWithEmptyLastName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.find(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_EMPTY_NAME));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenFindMethodCallWithBlankLastName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.find(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_BLANK_NAME));
    }
    ...
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenRemoveMethodCallWithNullFirstName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.remove(EMPLOYEE_NULL_NAME, EMPLOYEE_LASTNAME_1));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenRemoveMethodCallWithEmptyFirstName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.remove(EMPLOYEE_EMPTY_NAME, EMPLOYEE_LASTNAME_1));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenRemoveMethodCallWithBlankFirstName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.remove(EMPLOYEE_BLANK_NAME, EMPLOYEE_LASTNAME_1));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenRemoveMethodCallWithBadLastName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.remove(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_BAD_LASTNAME));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenRemoveMethodCallWithNullLastName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.remove(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_NULL_NAME));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenRemoveMethodCallWithEmptyLastName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.remove(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_EMPTY_NAME));
    }

    @Test
    public void shouldReturnThrowEmployeeNotValidNameExceptionWhenRemoveMethodCallWithBlankLastName() {
        assertThrows(EmployeeNotValidNameException.class, () -> out.remove(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_BLANK_NAME));
    }
    ...
    public void shouldReturnEmptyCollectionWhenGetEmployeesMethodCallBeforeAddFirstElement() {
        assertIterableEquals(Collections.unmodifiableList(List.of()), out.getEmployees());
    }

    @Test
    public void shouldReturnEmployeeCollectionWhenGetEmployeesMethodCall() {
        Collection<Employee> employeesActual = new ArrayList<>(
                List.of(
                        out.add(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_LASTNAME_1, EMPLOYEE_SALARY, EMPLOYEE_DEPARTMENT),
                        out.add(EMPLOYEE_FIRSTNAME_3, EMPLOYEE_LASTNAME_3, EMPLOYEE_SALARY, EMPLOYEE_DEPARTMENT),
                        out.add(EMPLOYEE_FIRSTNAME_1, EMPLOYEE_LASTNAME_3, EMPLOYEE_SALARY, EMPLOYEE_DEPARTMENT),
                        out.add(EMPLOYEE_FIRSTNAME_3, EMPLOYEE_LASTNAME_1, EMPLOYEE_SALARY, EMPLOYEE_DEPARTMENT)
                )
        );

        Collection<Employee> employeesExpected = out.getEmployees();
        assertTrue(
                employeesExpected.size() == employeesActual.size()
